...
#original article of simulator

#Collecting Stats and Initiating Quarantine [3/3] by Greg Winther
...
class Dot(pygame.sprite.Sprite): #represents people
    def __init__(
        self,
        x,
        y,
        ...
        self.image = pygame.Surface([radius * 2, radius * 2]) #width, height
    ...
    def update(self):  #updates position of dot
        ...
        #normalize the velocity (currently too erratic)
    ...
    def killswitch(self, cycles_to_fate=20, mortality_rate=0.2): #mortality rate is 20%
...
class Simulation:
    ...
    def start(self, randomize=False):
        ...
        for i in range(self.n_susceptible): 
            #random x and y locations of the dots
        ...
        for i in range(self.T):
            ...
            collision_group = pygame.sprite.groupcollide(
                ...
                True,
                False, #susceptible ones will be removed
            )
            ...
            clock.tick(30) #for every second, at most 30 FRAMES SHOULD PASS
